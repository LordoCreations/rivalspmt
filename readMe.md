...
7. Leave replay ID blank at any point to stop early and skip remaining maps
8. The script writes a filled header (from `templates/headertemplate.md`) followed by all maps in order to `output/output.md`
